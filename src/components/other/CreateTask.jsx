...
const CreateTask = () => {
    ...
    const submitHandler = (e) => {
        ...
        // ✅ Build task object directly — don't use useState for this
        const newTask = {
            taskTitle,
            taskDescription,
            taskDate,
            ...
            failed: false,
            completed: false,
            taskNumber: `task_${Date.now()}` // unique id
        }
            ...
            <form onSubmit={submitHandler} className='flex flex-wrap w-full items-start justify-between'>
                ...
                <div className='w-1/2 flex flex-col items-start'>
                    ...
                    <textarea
                        ...
                        className='w-full h-44 text-sm py-1 px-2 rounded outline-none bg-transparent border border-gray-400'
                        cols="30" rows="10"
                    ></textarea>
